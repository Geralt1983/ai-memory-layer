...
def main(argv=None):
    ...
    pb.add_argument("--provider", choices=["voyage","openai"], default=os.getenv("EMBED_PROVIDER","voyage"))
    ...
    ps.add_argument("--provider", choices=["voyage","openai"], default=os.getenv("EMBED_PROVIDER","voyage"))
