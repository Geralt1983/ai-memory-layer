...
class TestAPI:
    ...
    def client(self, mock_memory_engine, mock_openai_integration):
        ...
        app.dependency_overrides[get_openai_integration] = lambda: mock_openai_integration
    ...
    def test_create_memory(self, client, mock_memory_engine):
        ...
        mock_memory_engine.add_memory.assert_called_once_with("Test memory", {"type": "test"})
    ...
    def test_search_memories(self, client, mock_memory_engine):
        ...
        # Setup mock
        mock_memories = [
            Memory(content="Python programming", metadata={"type": "code"}, relevance_score=0.9)
        ]
