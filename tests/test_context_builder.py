...
class TestContextBuilder:
    ...
    def test_build_context_mixed_sections(self, memory_engine):
        ...
        recent_index = next(i for i, line in enumerate(lines) if "## Recent Context:" in line)
        relevant_index = next(i for i, line in enumerate(lines) if "## Relevant Context:" in line)
    ...
    def test_build_context_with_mocked_engine(self, mock_memory_engine_with_search):
        ...
        mock_memory_engine_with_search.search_memories.assert_called_once_with("test query", 2)