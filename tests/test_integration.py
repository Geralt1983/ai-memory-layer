...
class TestFullIntegration:
    ...
    def test_end_to_end_memory_workflow(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            assert len(recent) == 2
            assert recent[0].content == "Machine learning uses algorithms"  # Most recent
    ...
    def test_openai_integration_workflow(self, mock_openai_class):
        ...
        mock_chat_response.choices[0].message.content = "I understand you're asking about Python!"
        ...
        with patch('integrations.openai_integration.OpenAIEmbeddings') as mock_embeddings:
            ...
            ai_messages = [m for m in memory_engine.memories if "Assistant:" in m.content]
