...
from core.logging_config import (
    get_logger, MemoryLayerLogger, JSONFormatter,
    log_memory_operation, log_api_request, log_embedding_operation,
    monitor_performance
)
...
class TestLoggingConfig:
    ...
    def test_log_embedding_operation(self):
        ...
        with patch('core.logging_config.get_logger') as mock_get_logger:
            ...
            log_embedding_operation("embed_text", 100, "text-embedding-ada-002", dimension=1536)
