...
class TestMemoryEngine:
    ...
    def test_memory_engine_with_dependencies(self, faiss_store, mock_embedding_provider, temp_file):
    ...
    def test_load_memories_with_corrupted_file(self, mock_embedding_provider, temp_file):
