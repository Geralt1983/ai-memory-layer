...
class TestOpenAIIntegration:
    ...
    def test_openai_integration_creation(self, mock_context_builder, mock_embeddings, mock_openai):
    ...
    @patch('integrations.openai_integration.OpenAIEmbeddings')
    @patch('integrations.openai_integration.ContextBuilder')
    def test_chat_with_memory_basic(self, mock_context_builder, mock_embeddings, mock_openai):
    ...
    @patch('integrations.openai_integration.OpenAIEmbeddings')
    @patch('integrations.openai_integration.ContextBuilder')
    def test_chat_with_system_prompt(self, mock_context_builder, mock_embeddings, mock_openai):
    ...
    @patch('integrations.openai_integration.OpenAIEmbeddings')
    @patch('integrations.openai_integration.ContextBuilder')
    def test_chat_with_context(self, mock_context_builder, mock_embeddings, mock_openai):
        ...
        context_messages = [m for m in messages if "Previous context:" in m.get('content', '')]
    ...
    @patch('integrations.openai_integration.OpenAIEmbeddings')
    @patch('integrations.openai_integration.ContextBuilder')
    def test_chat_remember_response(self, mock_context_builder, mock_embeddings, mock_openai):
        ...
        user_memory = next((m for m in memory_engine.memories if "User:" in m.content), None)
        ai_memory = next((m for m in memory_engine.memories if "Assistant:" in m.content), None)
    ...
    @patch('integrations.openai_integration.OpenAIEmbeddings')
    @patch('integrations.openai_integration.ContextBuilder')
    def test_context_builder_parameters(self, mock_context_builder, mock_embeddings, mock_openai):
